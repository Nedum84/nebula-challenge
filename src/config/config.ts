...
const envVarsSchema = Joi.object()
  .keys({
    ...
    COGNITO_CLIENT_SECRET: Joi.string().default(
      "dnel7s515mgqk74rurtt1rhqsb0p21kgmu1nf1jdlcfvo04lvde"
    ),

    // DynamoDB Configuration
    DYNAMODB_LEADERBOARD_TABLE: Joi.string().default("leaderboard"),
    DYNAMODB_LEADERBOARD_ARN: Joi.string().default(
      "arn:aws:dynamodb:eu-north-1:893130088846:table/leaderboard"
    ),

    // WebSocket Configuration
    WEBSOCKET_CONNECTION_URL: Joi.string().default(
      "https://gdjtdhxwkf.execute-api.eu-north-1.amazonaws.com/production/@connections"
    ),
